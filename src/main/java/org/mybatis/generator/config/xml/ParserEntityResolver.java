    ...
    public InputSource resolveEntity(String publicId, String systemId)
        ...
        if (XmlConstants.IBATOR_CONFIG_PUBLIC_ID.equalsIgnoreCase(publicId)) {
            InputStream is = getClass().getClassLoader().getResourceAsStream(
                    "org/mybatis/org.mybatis.generator/config/xml/ibator-config_1_0.dtd"); //$NON-NLS-1$
            ...
            InputStream is = getClass()
                    .getClassLoader()
                    .getResourceAsStream(
                            "org/mybatis/org.mybatis.generator/config/xml/mybatis-org.mybatis.generator-config_1_0.dtd"); //$NON-NLS-1$
            InputSource ins = new InputSource(is);
