...
/**
 * This is an Ant task that will run the org.mybatis.generator. The following is a sample
 * Ant script that shows how to run the org.mybatis.generator from Ant:
 * 
 * <pre>
 ...
 *               classname="org.mybatis.org.mybatis.generator.ant.GeneratorAntTask"
 *               classpath="mybatis-org.mybatis.generator-core-x.x.x.jar" /&gt;
 ...
 * false (default), then existing Java files will be untouched and the org.mybatis.generator
 * will write new Java files with a unique name</li>
 * <li>"verbose" - if true, then the org.mybatis.generator will log progress messages to the
