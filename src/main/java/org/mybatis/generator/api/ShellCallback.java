...
public interface ShellCallback {
     ...
     *             the file system. In this case, the org.mybatis.generator will not save the file
     *             it is currently working on. The org.mybatis.generator will add the exception
     ...
     * (formatted). The org.mybatis.generator will write the merged source as-is to the file
     * system.
     * 
     ...
     *             existing file will remain undisturbed. The org.mybatis.generator will add the
    ...
    /**
     * Return true if the org.mybatis.generator should overwrite an existing file if one exists.
