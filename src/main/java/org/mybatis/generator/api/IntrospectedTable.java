...
/**
 * Base class for all code org.mybatis.generator implementations. This class provides many
 * of the housekeeping methods needed to implement a code org.mybatis.generator, with only
...
//        setExampleType(sb.toString());
    ...
    /**
     * Should return true if an XML org.mybatis.generator is required for this table.
