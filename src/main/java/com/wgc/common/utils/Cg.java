...
public class Cg {
    ...
    private final String mapper_package = "com.mryx.grampus.dao";

    private final String service_package = "com.mryx.grampus.service";

    private final String i_service_package = "com.mryx.grampus.rpc";

    private final String driverName = "com.mysql.jdbc.Driver";

    private final String user = "root";

    private final String password = "gmsroot";

    private final String url = "jdbc:mysql://172.16.30.57:3306/" + dbName + "?characterEncoding=utf8";
